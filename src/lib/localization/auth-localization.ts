import { ADMIN_ERROR_CODES } from './admin-error-codes.js';
import { ANONYMOUS_ERROR_CODES } from './anonymous-error-codes.js';
import { API_KEY_ERROR_CODES } from './api-key-error-codes.js';
import { BASE_ERROR_CODES } from './base-error-codes.js';
import { CAPTCHA_ERROR_CODES } from './captcha-error-codes.js';
import { EMAIL_OTP_ERROR_CODES } from './email-otp-error-codes.js';
import { GENERIC_OAUTH_ERROR_CODES } from './generic-oauth-error-codes.js';
import { HAVEIBEENPWNED_ERROR_CODES } from './haveibeenpwned-error-codes.js';
import { MULTI_SESSION_ERROR_CODES } from './multi-session-error-codes.js';
import { ORGANIZATION_ERROR_CODES } from './organization-error-codes.js';
import { PASSKEY_ERROR_CODES } from './passkey-error-codes.js';
import { PHONE_NUMBER_ERROR_CODES } from './phone-number-error-codes.js';
import { STRIPE_ERROR_CODES } from './stripe-localization.js';
import { TWO_FACTOR_ERROR_CODES } from './two-factor-error-codes.js';
import { USERNAME_ERROR_CODES } from './username-error-codes.js';
